...
public class SetupQuarterlyCrossSiteIndicatorBySiteReport {
	...
	public void setup() throws Exception {
		...
		h.createXlsOverview(rd, "PIH_Quaterly_Cross_Region_Indicator_Form.xls", "PIH Quarterly Cross Region Indicator Form (Excel)_", null);
	}
	
	public void delete() {
		ReportService rs = Context.getService(ReportService.class);
		for (ReportDesign rd : rs.getAllReportDesigns(false)) {
			if ("PIH Quarterly Cross Region Indicator Form (Excel)_".equals(rd.getName())) {
